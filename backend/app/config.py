...
# MPU gates personal-baseline sampling and separates static pressure rules from
# gait analysis. Temperature stays independent; missing MPU data fails open.
...
GAIT_CONFIRMED_EPISODE_COUNT = 3
GAIT_CONFIRMED_MIN_STEPS = 18
GAIT_LOAD_ASYMMETRY_THRESHOLD = 0.30
GAIT_REGION_DELTA_THRESHOLD = 0.15
GAIT_REGION_REPEAT_RATIO = 0.70
GAIT_STEP_INTERVAL_CV_THRESHOLD = 0.25
...
REGIONAL_RATIO_DELTA_THRESHOLD = 0.10
REGIONAL_RATIO_EXIT_THRESHOLD = 0.06
REGIONAL_NOISE_MULTIPLIER = 3.0
...
RECOVERY_BEFORE_WINDOW_MS = 3_000
RECOVERY_AFTER_WINDOW_MS = 5_000
RECOVERY_MIN_VALID_PAIRS = 5
