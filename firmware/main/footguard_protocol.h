...
enum {
    ...
    FOOTGUARD_LAYOUT_ID_6P3T_V1 = 1,
    FOOTGUARD_SENSOR_FRAME_SIZE = 58,
    FOOTGUARD_SENSOR_FRAME_CRC_OFFSET = 56,
    FOOTGUARD_SENSOR_FRAME_CRC_INPUT_SIZE = 56,
    FOOTGUARD_PRESSURE_CHANNEL_COUNT = 6,
    FOOTGUARD_TEMPERATURE_CHANNEL_COUNT = 3,
...
#define FOOTGUARD_QUALITY_FLAGS_V1_MASK UINT32_C(0x00007FFF)
