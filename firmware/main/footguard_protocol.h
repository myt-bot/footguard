...
#define FOOTGUARD_QUALITY_PRESSURE_INVALID_MASK UINT32_C(0x0000003F)
#define FOOTGUARD_QUALITY_TEMPERATURE_INVALID_MASK UINT32_C(0x000003C0)
#define FOOTGUARD_QUALITY_IMU_INVALID UINT32_C(0x00000400)
#define FOOTGUARD_QUALITY_TIME_UNSYNCED UINT32_C(0x00000800)
#define FOOTGUARD_QUALITY_TEMPERATURE_T1_INVALID UINT32_C(0x00000040)
