...
static const uint8_t LEFT_FRAME_V1[] = {
    0x46, 0x47, 0x01, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
    0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x2C,
    0xC8, 0x99, 0x01, 0x00, 0x00, 0x08, 0x07, 0x1C, 0x0C, 0x68,
    0x10, 0x98, 0x08, 0xC4, 0x09, 0xB0, 0x04, 0xFE, 0x0B, 0x08,
    0x0C, 0xE0, 0x0B, 0xF4, 0x0B, 0x02, 0x00, 0xFD, 0xFF, 0xE5,
    0x03, 0x01, 0x00, 0x02, 0x00, 0xFF, 0xFF, 0x5F, 0x2F, 0x1C
};

static const uint8_t RIGHT_FRAME_V1[] = {
    0x46, 0x47, 0x01, 0x02, 0x01, 0x00, 0x00, 0x00, 0x00, 0x01,
    0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x14, 0xC0, 0x2C,
    0xC8, 0x99, 0x01, 0x00, 0x00, 0xA4, 0x06, 0xB8, 0x0B, 0xA0,
    0x0F, 0xD0, 0x07, 0x60, 0x09, 0x14, 0x05, 0xF4, 0x0B, 0xFE,
    0x0B, 0xD6, 0x0B, 0xEA, 0x0B, 0xFF, 0xFF, 0x02, 0x00, 0xE6,
    0x03, 0xFF, 0xFF, 0x01, 0x00, 0x00, 0x00, 0x5D, 0xC3, 0x25
};

_Static_assert(sizeof(LEFT_FRAME_V1) == FOOTGUARD_SENSOR_FRAME_SIZE,
               "Left standard vector size mismatch");
_Static_assert(sizeof(RIGHT_FRAME_V1) == FOOTGUARD_SENSOR_FRAME_SIZE,
               "Right standard vector size mismatch");
                           ...
                           const uint8_t *expected_frame)
{
    ...
    if (footguard_protocol_sensor_frame_crc_is_valid(encoded,
                                                     sizeof(encoded) - 1U)) {
        return false;
    }
...
bool footguard_protocol_selftest_left_frame(void)
{
    static const footguard_sensor_data_t SENSOR_DATA = {
        ...
        .temperature_c = {30.7, 30.8, 30.4, 30.6},
...
bool footguard_protocol_selftest_right_frame(void)
{
    static const footguard_sensor_data_t SENSOR_DATA = {
        ...
        .temperature_c = {30.6, 30.7, 30.3, 30.5},
